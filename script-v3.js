...
const GA_EVENT_LINKS = [
  {
    selector: '.buy-track-button',
    eventName: 'buy_digital_track',
    params: {
      track_title: 'Big Black Puppet',
      platform: 'Bandcamp',
      destination_url: 'https://sashapersholja.bandcamp.com/track/sasha-persholja-big-black-puppet'
    }
  },
  {
